...
| [`cron/`](cron/) | Cron job specs — 31 active cron definitions covering nightly extraction, morning briefing, mention monitor, brain-feed, contemplation, backup, and more |
